...
import {
  ...
  Mail, Video, Building2, Shield, User
} from 'lucide-react'
          ...
          <div className="px-6 pb-6 -mt-10">
            ...
            {isClaimed ? (
              <div className="flex flex-wrap gap-3">
                {listing.phone && (
                  <a href={`tel:${listing.phone}`} className="btn-primary flex items-center gap-2">
                ...
                {listing.email && (
                  <a href={`mailto:${listing.email}`} className="btn-secondary flex items-center gap-2">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            {listing.disorders_treated && listing.disorders_treated.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {listing.disorders_treated.map((d: string) => (
            ...
            {listing.treatment_approaches && listing.treatment_approaches.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {listing.treatment_approaches.map((t: string) => (
            ...
            {listing.communities_served && listing.communities_served.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {listing.communities_served.map((c: string) => (
            ...
            {listing.levels_of_care && listing.levels_of_care.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                ...
                <div className="space-y-1.5">
                  {listing.levels_of_care.map((l: string) => (
            ...
            {listing.ages_served && listing.ages_served.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {listing.ages_served.map((a: string) => (
            ...
            {listing.insurance_accepted && listing.insurance_accepted.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                ...
                <div className="space-y-1">
                  {listing.insurance_accepted.map((ins: string) => (
