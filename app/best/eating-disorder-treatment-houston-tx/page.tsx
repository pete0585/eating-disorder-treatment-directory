...
export default async function CityPage() {
  ...
  const faqLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How many eating disorder treatment are in Houston, TX?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Eating Disorder Treatment Directory lists 41+ eating disorder treatment in Houston, Texas. Counts change as new listings are seeded.",
        },
      },
      {
        "@type": "Question",
        name: "How do I find eating disorder treatment in Houston?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Search eatingdisordertreatmentfinder.com and filter by Houston. Compare listed providers, then contact the one that fits.",
        },
      },
    ],
  }
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <p className="mt-3 max-w-2xl text-neutral-600">
          41+ listed eating disorder treatment in the Houston area. Pages are generated from live directory listings — not outreach.
        </p>
